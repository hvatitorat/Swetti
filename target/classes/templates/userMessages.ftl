        ...
        <div class="col">
            <div class="card">
                <div class="card-body">
                    ...
                    <h3 class="card-text">
                        <a href="/user/subscriptions/${userChannel.id}/list" class="text-warning">${subscriptionsCount}</a>
                    </h3>
                </div>
            </div>
        </div>
        <div class="col">
            <div class="card">
                <div class="card-body">
                    ...
                    <h3 class="card-text">
                        <a href="/user/subscribers/${userChannel.id}/list" class="text-warning">${subscribersCount}</a>
                    </h3>
                </div>
            </div>
        </div>
